...
\newcommand{\keywords}[1]{{\footnotesize\usefont{OT1}{phv}{m}{sl}\color{Black}#1}\vspace{5pt} \hfill \today{}} % Institutions style (Helvetica)
...
\pretitle{
	...
	\fontsize{30}{36}\usefont{OT1}{phv}{b}{n}\selectfont % Helvetica
